                        ...
                        <div class="col-xl-3 col-xxl-4">
                            <div class="cat-banner row no-gutters">
                                ...
                                <div class="col-sm-6 col-xl-12 col-xxl-6">
                                    <div class="banner banner-overlay">
                                        <a href="#">
                                            <img src="{{ asset('frontend/assets/images/demos/demo-14/banners/banner-5.jpg') }}"
                                                alt="Banner img desc">
                                        </a>
                        ...
                        <div class="col-xl-3 col-xxl-4">
                            <div class="cat-banner row no-gutters">
                                ...
                                <div class="col-sm-6 col-xl-12 col-xxl-6">
                                    <div class="banner banner-overlay">
                                        <a href="#">
                                            <img src="{{ asset('frontend/assets/images/demos/demo-14/banners/banner-6.jpg') }}"
                                                alt="Banner img desc">
                                        </a>
                                            ...
                                            @foreach ($brandList as $data)
                                                <li class="nav-item">
                                                    <a class="nav-link" id="{{ Str::slug($data->b_title) }}-link"
                                                        data-toggle="tab"
                                                        href="#{{ Str::slug($data->b_title) }}-tab" role="tab"
                        ...
                        <div class="col-xl-3 col-xxl-4">
                            <div class="cat-banner row no-gutters">
                                ...
                                <div class="col-sm-6 col-xl-12 col-xxl-6">
                                    <div class="banner banner-overlay">
                                        <a href="#">
                                            <img src="{{ asset('frontend/assets/images/demos/demo-14/banners/banner-9.jpg') }}"
                                                alt="Banner img desc">
                                        </a>
                                            ...
                                            @foreach ($tagsList as $data)
                                                <li class="nav-item">
                                                    <a class="nav-link" id="{{ Str::slug($data->t_title) }}-link"
                                                        ...
                                                        role="tab" aria-controls="{{ Str::slug($data->t_title) }}-tab"
                                    ...
                                    @foreach ($tagsList as $data)
                                        <div class="tab-pane p-0 fade {{ $loop->index == 0 ? 'show active' : '' }}"
                                            ...
                                            @php
                                                ...
                                                $products = App\Models\Product::whereJsonContains('tag_key', (string)$data->id)->where('status', 1)->get();
                        ...
                        <div class="col-xl-3 col-xxl-4">
                            <div class="cat-banner row no-gutters">
                                ...
                                <div class="col-sm-6 col-xl-12 col-xxl-6">
                                    <div class="banner banner-overlay">
                                        <a href="#">
                                            <img src="{{ asset('frontend/assets/images/demos/demo-14/banners/banner-10.jpg') }}"
                                                alt="Banner img desc">
                                        </a>
                            ...
                            <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow"
                                ...
                                <div class="product text-center">
                                    <figure class="product-media">
                                        ...
                                        <a href="product.html">
                                            <img src="{{ asset('frontend/assets/images/demos/demo-14/products/product-18.jpg') }}"
                                                alt="Product image" class="product-image">
                                        </a>
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-title"><a href="product.html">KitchenAid Professional 500
                                                Series Stand Mixer</a></h3><!-- End .product-title -->
                                        <div class="product-price">
                                ...
                                <div class="product text-center">
                                    <figure class="product-media">
                                        <a href="product.html">
                                            <img src="{{ asset('frontend/assets/images/demos/demo-14/products/product-19.jpg') }}"
                                                alt="Product image" class="product-image">
                                        </a>
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-title"><a href="product.html">MoDRN Industrial 7 Piece</a>
                                        </h3><!-- End .product-title -->
                                        <div class="product-price">
                                            $40.00
                                        </div><!-- End .product-price -->
                                ...
                                <div class="product text-center">
                                    <figure class="product-media">
                                        <a href="product.html">
                                            <img src="{{ asset('frontend/assets/images/demos/demo-14/products/product-20.jpg') }}"
                                                alt="Product image" class="product-image">
                                        </a>
                                ...
                                <div class="product text-center">
                                    <figure class="product-media">
                                        ...
                                        <a href="product.html">
                                            <img src="{{ asset('frontend/assets/images/demos/demo-14/products/product-21.jpg') }}"
                                                alt="Product image" class="product-image">
                                        </a>
                                    ...
                                    <div class="product-body">
                                        ...
                                        <div class="product-nav product-nav-dots">
                                            <a href="#" class="active" style="background: #f1f1f1;"><span
                                                    class="sr-only">Color name</span></a>
                                            <a href="#" style="background: #c00b1b;"><span class="sr-only">Color
                                                    name</span></a>
                                        </div><!-- End .product-nav -->
                                    </div><!-- End .product-body -->
                                </div><!-- End .product -->
