                                            ...
                                            <tr>
                                                    ...
                                                    <div class="product">
                                                        <figure class="product-media">
                                                            <a href="#">
                                                                ...
                                                                <img src="{{ asset('uploads/' . $item->product->thumbImage->t_image) }}"
                                                                    alt="Product image">
                                                            </a>
                                                        </figure>
                                                ...
                                                <td class="quantity-col">
                                                    <div class="cart-product-quantity">
                                                        <input data-id="{{ $item->id }}" class="quantityValue"
                                                ...
                                                <td class="remove-col"><a href="{{ route('remove', $item->id) }}"
                                        ...
                                        <table class="table table-summary">
                                            <tbody>
                                                ...
                                                <tr class="summary-shipping-row">
                                                    <td>
                                                        <div class="custom-control custom-radio">
                                                            <input type="radio" checked id="free-shipping" name="shipping"
                                                                class="custom-control-input" value="Free Shipping">
                                                ...
                                                <tr class="summary-shipping-row">
                                                    <td>
                                                        <div class="custom-control custom-radio">
                                                            <input type="radio" id="standart-shipping"
                                                                value="Standart Shipping" name="shipping"
                                                ...
                                                <tr class="summary-shipping-row">
                                                    <td>
                                                        <div class="custom-control custom-radio">
                                                            <input type="radio" id="express-shipping"
                                                                value="Express Shipping" name="shipping"
                                                                class="custom-control-input">
                                                            <label class="custom-control-label"
...
@push('scripts')
    <script>
        $(document).ready(function() {
            ...
            var initialValue = $('.quantityValue').val();
            ...
            $('.quantityValue').on('input', function() {
                ...
                if (newValue !== initialValue) {
                    ...
                    $.ajax({
                        ...
                        method: 'GET', // or 'GET' based on your server route
                        data: {
                            value: newValue
                        },
