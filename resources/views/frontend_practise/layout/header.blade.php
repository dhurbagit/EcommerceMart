        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-auto col-lg-3 col-xl-3 col-xxl-2">
                    ...
                    <a href="/" class="logo">
                        <img src="{{ asset('frontend/assets/images/demos/demo-14/logo.png') }}" alt="Molla Logo"
                            width="105" height="25">
                    </a>
                        ...
                        <div class="col-lg-4 col-xxl-5col d-flex justify-content-end align-items-center">
                            <div class="header-dropdown-link">
                                ...
                                <div class="dropdown cart-dropdown">
                                    <a href="{{ route('shoppingCart') }}" class="dropdown-toggle" role="button"
                                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                        data-display="static">
                                        <i class="icon-shopping-cart"></i>
                                        <span class="cart-count">
                                            {{-- cart-count will dynamically generated --}}
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <div class="dropdown-cart-action">
                                            <a href="{{ route('shoppingCart') }}" class="btn btn-primary">View
                                                Cart</a>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-auto col-lg-3 col-xl-3 col-xxl-2 header-left">
                    <div class="dropdown category-dropdown {{ request()->is('/') ? '' : '' }} is-on"
                        data-visible="true">
                        <a href="#" class="dropdown-toggle" role="button" data-toggle="dropdown"
                            aria-haspopup="true" aria-expanded="false" data-display="static"
                                                ...
                                                <div class="col-md-4">
                                                    <div class="banner banner-overlay">
                                                        <a href="category.html" class="banner banner-menu">
                                                            <img src="{{ asset('frontend/assets/images/demos/demo-13/menu/banner-1.jpg') }}"
                                                                alt="Banner">
                                                        </a>
                                        ...
                                        <div class="megamenu">
                                            <div class="row no-gutters">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="banner banner-overlay">
                                                        <a href="category.html" class="banner banner-menu">
                                                            <img src="{{ asset('frontend/assets/images/demos/demo-13/menu/banner-2.jpg') }}"
                                                                alt="Banner">
                                                        </a>
                                                    </div><!-- End .banner banner-overlay -->
                                                </div><!-- End .col-md-4 -->
                                            ...
                                            <div class="menu-col">
                                                ...
                                                <div class="row menu-banners">
                                                    <div class="col-md-4">
                                                        <div class="banner">
                                                            <a href="#">
                                                                <img src="{{ asset('frontend/assets/images/demos/demo-13/menu/1.jpg') }}"
                                                                    alt="image">
                                                            </a>
                                                        </div><!-- End .banner -->
                                                    </div><!-- End .col-md-4 -->
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="banner">
                                                            <a href="#">
                                                                <img src="{{ asset('frontend/assets/images/demos/demo-13/menu/2.jpg') }}"
                                                                    alt="image">
                                                            </a>
                                                        </div><!-- End .banner -->
                                                    </div><!-- End .col-md-4 -->
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="banner">
                                                            <a href="#">
                                                                <img src="{{ asset('frontend/assets/images/demos/demo-13/menu/3.jpg') }}"
                                                                    alt="image">
                                                            </a>
                                                        </div><!-- End .banner -->
                                                    </div><!-- End .col-md-4 -->
                                        ...
                                        <div class="megamenu">
                                            <div class="row no-gutters">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="banner banner-overlay">
                                                        <a href="category.html" class="banner banner-menu">
                                                            <img src="{{ asset('frontend/assets/images/demos/demo-13/menu/banner-3.jpg') }}"
                                                                alt="Banner">
                                                        </a>
                                                    </div><!-- End .banner banner-overlay -->
                                                </div><!-- End .col-md-4 -->
                                            ...
                                            <div class="menu-col menu-brands">
                                                <div class="row">
                                                    <div class="col-lg-2">
                                                        <a href="#" class="brand">
                                                            <img src="{{ asset('frontend/assets/images/brands/1.png') }}"
                                                                alt="Brand Name">
                                                        </a>
                                                    </div><!-- End .col-lg-2 -->
                                                    ...
                                                    <div class="col-lg-2">
                                                        <a href="#" class="brand">
                                                            <img src="{{ asset('frontend/assets/images/brands/2.png') }}"
                                                                alt="Brand Name">
                                                        </a>
                                                    </div><!-- End .col-lg-2 -->
                                                    ...
                                                    <div class="col-lg-2">
                                                        <a href="#" class="brand">
                                                            <img src="{{ asset('frontend/assets/images/brands/3.png') }}"
                                                                alt="Brand Name">
                                                        </a>
                                                    </div><!-- End .col-lg-2 -->
                                                    ...
                                                    <div class="col-lg-2">
                                                        <a href="#" class="brand">
                                                            <img src="{{ asset('frontend/assets/images/brands/4.png') }}"
                                                                alt="Brand Name">
                                                        </a>
                                                    </div><!-- End .col-lg-2 -->
                                                    ...
                                                    <div class="col-lg-2">
                                                        <a href="#" class="brand">
                                                            <img src="{{ asset('frontend/assets/images/brands/5.png') }}"
                                                                alt="Brand Name">
                                                        </a>
                                                    </div><!-- End .col-lg-2 -->
                                                    ...
                                                    <div class="col-lg-2">
                                                        <a href="#" class="brand">
                                                            <img src="{{ asset('frontend/assets/images/brands/6.png') }}"
                                                                alt="Brand Name">
                                                        </a>
                                                    </div><!-- End .col-lg-2 -->
                                                </div><!-- End .row -->
                                        ...
                                        <div class="col-md-6">
                                            <div class="banner banner-overlay">
                                                <a href="category.html">
                                                    <img src="{{ asset('frontend/assets/images/menu/banner-2.jpg') }}"
                                                        alt="Banner">
