                            ...
                            <div class="product-gallery product-gallery-vertical">
                                <div class="row">
                                    <figure class="product-main-image">
                                        ...
                                        <img id="product-zoom"
                                            src="{{ asset('uploads/') }}/{{ $products->thumbImage->t_image }}"
                                            data-zoom-image="{{ asset('uploads/') }}" alt="product image">
                                    ...
                                    <div id="product-zoom-gallery" class="product-image-gallery">
                                        @foreach ($products->thumbImage->galleryImages as $galleryImage)
                                            <a class="product-gallery-item active" href="#"
                                                data-image="{{ asset('uploads/') }}/{{ $galleryImage->g_image }}"
                                                data-zoom-image="{{ asset('uploads/') }}/{{ $galleryImage->g_image }}">
                                                <img src="{{ asset('uploads/') }}/{{ $galleryImage->g_image }}"
                                                    alt="product side">
                                            </a>
                                        @endforeach
                                    ...
                                    <div class="details-filter-row details-row-size">
                                        ...
                                        <div class="product-nav product-nav-thumbs">
                                            @foreach (json_decode($products->color, true) as $color)
                                                <input type="radio" name="color" class="form-control1"
                                                    value="{{ $color }}">
                                                <input type="color" name="color" disabled class="form-control1"
                                                    value="{{ $color }}">
                                            @endforeach
